...
for index in range(len(listADCP)):
		...
		adcp12.Variables.v=np.vstack((adcp12.Variables.v,adcp.Variables.v))
		adcp12.Variables.u=np.vstack((adcp12.Variables.u,adcp.Variables.u))
...
diff_u=abs(adcps.Variables.u - velos3['u'])
diff_v=abs(adcps.Variables.v - velos3['v'])
#not working yet^
